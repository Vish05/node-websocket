    ...
    <Box w='container.md'>
      <form onSubmit={handleSubmit(onSubmit)} style={{ width: '100%' }}>
        <FormControl isInvalid={!!errors.gameName}>
          ...
          />
          <FormErrorMessage>{errors.gameName && errors.gameName.message}</FormErrorMessage>
        </FormControl>

        <Button mt={4} colorScheme='green' isLoading={isSubmitting} type='submit' width='full' size='lg'>
          Start game
        </Button>
      </form>
    </Box>
